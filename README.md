...
- **Productivity Features**: Ralph Loop, Task Continuation Enforcer, Comment Checker, Think Mode, and more
...
- **Sisyphus Agent**: Main orchestrator with Prometheus and Plan Synthesizer
- **Multi-Plan Pipeline**: `multi_plan_pipeline` toggles routing + synthesizer verification behavior
...
**Curious about the philosophy behind this project?** Read the [Documentation Index](docs/index.md).
