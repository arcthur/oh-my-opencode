...
export type ModelRequirement = {
  ...
  requiresProvider?: string[] // If set, only activates when any provider in this list is connected
}

/**
 * Model requirements for each agent.
 *
 * Key fields:
 * - `requiresModel`: Agent only activates when this specific model is available
 * - `requiresAnyModel`: Agent requires at least one model from fallbackChain
