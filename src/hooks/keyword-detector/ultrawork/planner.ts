...
|------|-------|------------------|
| 1 | 1, 4 | \`delegate_task(description="Task 1", category="...", load_skills=[...], run_in_background=false, prompt="...")\` × 2 |
| 2 | 2, 3, 5 | \`delegate_task(description="Task N", category="...", load_skills=[...], run_in_background=false, prompt="...")\` × 3 after Wave 1 completes |
