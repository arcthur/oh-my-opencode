...
describe("category-skill-reminder hook", () => {
  ...
  describe("target agent detection", () => {
    test("should inject reminder for sisyphus agent after 3 tool calls", async () => {
      ...
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "1", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "2", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "3", agent }, output)
    ...
    test("should inject reminder for atlas agent", async () => {
      ...
      await hook["tool.execute.after"]({ tool: "bash", sessionID, callID: "1", agent }, output)
      await hook["tool.execute.after"]({ tool: "bash", sessionID, callID: "2", agent }, output)
      await hook["tool.execute.after"]({ tool: "bash", sessionID, callID: "3", agent }, output)
    ...
    test("should inject reminder for sisyphus-junior agent", async () => {
      ...
      // when - 3 tool calls are made
      await hook["tool.execute.after"]({ tool: "write", sessionID, callID: "1", agent }, output)
      await hook["tool.execute.after"]({ tool: "write", sessionID, callID: "2", agent }, output)
      await hook["tool.execute.after"]({ tool: "write", sessionID, callID: "3", agent }, output)
  ...
  describe("delegation tool tracking", () => {
    test("should NOT inject reminder if delegate_task is used", async () => {
      ...
      await hook["tool.execute.after"]({ tool: "delegate_task", sessionID, callID: "1", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "2", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "3", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "4", agent }, output)
    ...
    test("should NOT inject reminder if call_omo_agent is used", async () => {
      ...
      await hook["tool.execute.after"]({ tool: "call_omo_agent", sessionID, callID: "1", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "2", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "3", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "4", agent }, output)
    ...
    test("should NOT inject reminder if task tool is used", async () => {
      ...
      await hook["tool.execute.after"]({ tool: "task", sessionID, callID: "1", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "2", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "3", agent }, output)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "4", agent }, output)
  ...
  describe("tool call counting", () => {
    ...
    test("should only inject reminder once per session", async () => {
      ...
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "1", agent }, output1)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "2", agent }, output1)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "3", agent }, output1)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "4", agent }, output2)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "5", agent }, output2)
      await hook["tool.execute.after"]({ tool: "edit", sessionID, callID: "6", agent }, output2)
    ...
    test("should only count delegatable work tools", async () => {
      ...
      await hook["tool.execute.after"]({ tool: "lsp_goto_definition", sessionID, callID: "1", agent }, output)
      await hook["tool.execute.after"]({ tool: "lsp_find_references", sessionID, callID: "2", agent }, output)
      await hook["tool.execute.after"]({ tool: "lsp_symbols", sessionID, callID: "3", agent }, output)
