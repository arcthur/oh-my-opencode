...
const REGISTRY: RuntimeRegistryEntry[] = [
  ...
  { name: "work-orchestrator", events: ["chat.message", "tool.execute.before", "tool.execute.after", "event"] },
  ...
  { name: "orchestrator-contextual-injector", events: ["chat.message", "tool.execute.before", "event"] },
  ...
  { name: "specialist-notepad", events: ["tool.execute.before"] },
