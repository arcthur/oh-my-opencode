/**
 * orchestrator Swarm - Multi-Agent Coordination System
 *
 ...
 *      └───────────────┴───────────────┘
 *                      ▼
 *         .orchestrator/teams/{team}/inboxes/
 * ```
 *
 * @see docs/journeys/swarm-coordination.md for end-to-end usage
 * @see src/features/orchestrator-swarm/ARCHITECTURE.md for implementation-level architecture notes
 *
 * @example
 * ```typescript
 * import {
 ...
 *   createWorker,
 *   createSwarmTask,
 * } from "./features/orchestrator-swarm"
 *
 * // Start coordinator
...
export const SWARM_STORAGE_PATH = ".orchestrator/teams"
