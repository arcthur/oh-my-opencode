 ...
 *
 * Match policy: tmux window option @swarm_team only.
 */
...
export const SWARM_ENV = {
  ...
  /** Project root for worktree mode - ensures all agents share the same .orchestrator */
  PROJECT_ROOT: "ORCHESTRATOR_PROJECT_ROOT",
} as const
