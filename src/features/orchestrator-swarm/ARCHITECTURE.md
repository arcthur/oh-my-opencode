# orchestrator Swarm Architecture (2026-02)

This document describes the current implementation of orchestrator Swarm, including control-plane responsibilities, data-plane semantics, concurrency guarantees, and security boundaries.
...
- Control plane: `src/features/orchestrator-swarm/agent/`
- Team + lease + heartbeat + idle: `src/features/orchestrator-swarm/team/`
- Mailbox + transport: `src/features/orchestrator-swarm/mailbox/`
- Security: `src/features/orchestrator-swarm/security/`
- Task assignment: `src/features/orchestrator-swarm/task-graph/`
- Runtime owner: `src/features/orchestrator-swarm/runtime/`
