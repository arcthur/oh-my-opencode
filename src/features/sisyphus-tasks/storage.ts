 ...
 * To ensure all agents share the same .sisyphus directory, the orchestrator
 * sets this environment variable to the main project directory.
 */
export const SISYPHUS_PROJECT_ROOT_ENV = "SISYPHUS_PROJECT_ROOT"

/**
 * Get the project root directory
 *
 * Priority:
 * 1. SISYPHUS_PROJECT_ROOT environment variable (worktree mode)
