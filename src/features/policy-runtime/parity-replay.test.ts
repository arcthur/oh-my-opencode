...
import type { ExecutionContract, PolicyDecision, PolicyEventInput } from "../../contracts"
...
function loadReplayFixture(): ReplayFixtureRecord[] {
  const fileUrl = new URL("./fixtures/policy-replay-session.jsonl", import.meta.url)
