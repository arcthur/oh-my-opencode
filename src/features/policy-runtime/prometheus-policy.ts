...
export const PROMETHEUS_ALLOWED_EXTENSIONS = [".md"]

export const PROMETHEUS_ALLOWED_PATH_PREFIX = ".sisyphus"

export const PROMETHEUS_MUTATION_TOOLS = ["Write", "Edit", "write", "edit"]
