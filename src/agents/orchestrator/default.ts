/**
 * Default (non-GPT) execution governance profile used in the orchestrator prompt.
 */
export const ORCHESTRATOR_EXECUTION_PROFILE_NON_GPT = `## Execution Profile (Non-GPT)
...
export function getDefaultOrchestratorExecutionProfile(): string {
  return ORCHESTRATOR_EXECUTION_PROFILE_NON_GPT
}
