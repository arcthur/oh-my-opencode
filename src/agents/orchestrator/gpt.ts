...
/**
 * GPT-family execution governance profile used in the orchestrator prompt.
 */
export const ORCHESTRATOR_EXECUTION_PROFILE_GPT = `## Execution Profile (GPT-family)
...
export function getGptOrchestratorExecutionProfile(): string {
  return ORCHESTRATOR_EXECUTION_PROFILE_GPT
}
