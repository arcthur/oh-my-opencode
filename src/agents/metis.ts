...
\`\`\`
delegate_task(description="Explore: current handling of X", subagent_type="explore", load_skills=[], run_in_background=true, prompt="I'm researching how to implement [feature] and need to understand the current approach. Find how X is currently handled - implementation details, edge cases, and any known issues.")
