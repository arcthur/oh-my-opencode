...
delegate_task(
  ...
  prompt="Review .sisyphus/plans/{plan-id}/plan.md with strict standards: edge cases, ordering, rollback, and verification quality."
)
\`\`\`
...
2. If Momus finds blockers:
   - Fix the plan directly in \`.sisyphus/plans/{plan-id}/plan.md\`
...
- Final Plan: \`.sisyphus/plans/{plan-id}/plan.md\` (updated with stricter fixes)
