...
Generate plan to: \`.orchestrator/plans/{plan-id}/plan.md\`
Generate context manifest to: \`.orchestrator/context-manifests/{plan-id}.md\`
...
- Path: \`.orchestrator/designs/{topic-slug}.md\` (if brainstorming was used; omit for trivial/simple)
...
- Plan: \`.orchestrator/plans/{plan-id}/plan.md\`
...
- **Evidence Paths**: Use \`.orchestrator/evidence/task-{N}-{scenario-slug}.{ext}\`

**Evidence Requirements:**
- Screenshots: \`.orchestrator/evidence/\` for all UI scenarios
...
- 1. [Task Title]
  ...
  **Agent-Executed QA Scenarios (MANDATORY):**
  ...
  - Evidence saved under: \`.orchestrator/evidence/task-{N}-{scenario-slug}.{ext}\`
