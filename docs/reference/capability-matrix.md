...
|---|---|---|---|
| Planning → execution | `docs/journeys/planning-to-execution.md` | `docs/reference/tools.md`, `docs/reference/agents.md`, `docs/reference/hooks.md` | `src/hooks/atlas/`, `src/tools/delegate-task/` |
...
| Swarm coordination | `docs/journeys/swarm-coordination.md` | `docs/reference/tools.md`, `docs/reference/artifacts-and-paths.md` | `src/tools/swarm.ts`, `src/features/sisyphus-swarm/`, `src/hooks/swarm-agent/` |
...
| Conditional rules | `docs/journeys/conditional-rules.md` | `docs/reference/hooks.md` | `src/features/conditional-rules/`, `src/hooks/rules-injector/` |
...
- `compaction-context-injector` exists under `src/hooks/compaction-context-injector/`, but it is **not currently wired** in `src/index.ts`.
- Claude Code `PreCompact` support exists under `src/hooks/claude-code-hooks/pre-compact.ts`, but the OpenCode surface (`experimental.session.compacting`) is **not currently wired** in `src/index.ts`.
